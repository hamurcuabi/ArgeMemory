...
public class UpdateDescpPopup extends AppCompatDialogFragment {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!edtNewTag.getText().toString().trim().isEmpty()) {
                    ...
                    String query=" Update SHARE set NAME='"+edtNewTag.getText().toString().trim()+"' " +
                            "where ID='"+shareid+"'";
                    updateDescp.execute(query);
